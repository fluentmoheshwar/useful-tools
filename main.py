...
@eel.expose
def openHosts():
    os.system("attrib -r %WINDIR%\system32\drivers\etc\hosts && start notepad.exe %windir%\system32\drivers\etc\hosts")
...
def openAllUsersStartup():
    os.system("explorer.exe C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp")
...
def openPSReadLineHistory():
    os.system("notepad %AppData%\Microsoft\Windows\PowerShell\PSReadLine\ConsoleHost_history.txt")
